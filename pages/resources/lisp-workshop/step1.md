...
A REPL is a program that does exactly four things in order: a Read, Eval, Print, Loop.
...
- Eval: Evaluation converts the expression the user gave into a value. For example, evaluating `1 + 2` results in `3`.
...
You'll need to use your language's functions for gettint user input, and printing strings.
