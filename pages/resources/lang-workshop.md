...
The steps are designed to be completed in order; if you're stuck on one of the steps, ask someone for help in the workshop, or post a message on our [Discord server][discord].
...
The only prior knowledge we assume is that you know the basics of programming.
