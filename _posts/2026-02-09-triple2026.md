...
|     Track A                                      | Track B                                   |
|---------------------------------------------|-------------------------------------------|
|     <button class="speaker" onclick="openPopup(A1)"><b>Trains, Pictures and Types</b><br>Prof. Simon Gay, University of Glasgow</button>|<button class="speaker" onclick="openPopup(B1)"><b>Title: Symbolic AI for Medical Knowledge Representation & Reasoning: Just The Right Amount -- SNOMED CT Content Extraction</b><br>Renate Schmidt, University of Manchester</button>|
|     <button class="speaker" onclick="openPopup(A2)"><b>Algebra and Normalisation</b><br>Dr. Ohad Kammar, University of Edinburgh</button>| <button class="speaker" onclick="openPopup(B2)"><b>Phase Your Compilation</b><br>Constantine Theocharis, University of St Andrews</button>|
|     <button class="speaker" onclick="openPopup(A3)"><b>Programming with Cubes</b><br>Dr. Vikraman Choudhury & Rin Liu, University of Strathclyde</button>| <button class="speaker" onclick="openPopup(B3)"><b>AI meets Formal: Verification and optimization of systems modelled using machine learning</b><br>Dr. Konstantin Korovin, University of Manchester</button>|
