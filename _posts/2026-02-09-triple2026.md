...
| <b>12:00 | Lunch           | Lunch           |
| <b>13:00 |     <button class="speaker" onclick="openPopup(A3)">Dr. Fredrik Nordvall Forsberg<br>University of Strathclyde</button>| <button class="speaker" onclick="openPopup(B3)">Dr. Konstantin Korovin<br>University of Manchester</button>|
| <b>14:00 |     <button class="speaker" onclick="openPopup(A4)">Dr. Steven Ramsay<br>University of Bristol</button>| <button class="speaker" onclick="openPopup(B4)">Prof. Rob van Glabbeek<br>University of Edinburgh</button>|
| <b>15:00 | Break           | Break           |
| <b>15:30 |     <button class="speaker" onclick="openPopup(A5)">Dr. Vikraman Choudhury & Rin Liu<br>University of Strathclyde</button>| <button class="speaker" onclick="openPopup(B5)">André Videla<br>Glasgow Lab for AI Verification</button>|
