...
| <b>10:00 |     <button class="speaker" onclick="openPopup(A1)">Prof. Simon Gay<br>University of Glasgow</button><br><a href="#">slides</a>|<button class="speaker" onclick="openPopup(B1)">Dr. Renate Schmidt<br>University of Manchester</button><br><a href="#">slides</a>|
