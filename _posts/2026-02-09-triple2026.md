...
|-------------|--------------------------------------------------|-------------------------------------------|
| 09:00       | Gates Open      | Gates Open      |
| 09:50-10:00 | Opening Remarks | Opening Remarks |
| 10:00-11:00 |     <button class="speaker" onclick="openPopup(A1)"><b>Trains, Pictures and Types</b><br>Prof. Simon Gay<br>University of Glasgow</button>|<button class="speaker" onclick="openPopup(B1)"><b>Symbolic AI for Medical Knowledge Representation & Reasoning: Just The Right Amount -- SNOMED CT Content Extraction</b><br>Dr. Renate Schmidt<br>University of Manchester</button>|
| 11:00-12:00 |     <button class="speaker" onclick="openPopup(A2)"><b>Algebra and Normalisation</b><br>Dr. Ohad Kammar<br>University of Edinburgh</button>| <button class="speaker" onclick="openPopup(B2)"><b>Phase Your Compilation</b><br>Constantine Theocharis<br>University of St Andrews</button>|
| 12:00-13:00 | Lunch           | Lunch           |
| 13:00-14:00 |     <button class="speaker" onclick="openPopup(A3)"><b>Programming with Cubes</b><br>Dr. Vikraman Choudhury & Rin Liu<br>University of Strathclyde</button>| <button class="speaker" onclick="openPopup(B3)"><b>AI meets Formal: Verification and optimization of systems modelled using machine learning</b><br>Dr. Konstantin Korovin<br>University of Manchester</button>|
| 14:00-15:00 |     <button class="speaker" onclick="openPopup(A4)"><b>Types for (In)correctness</b><br>Dr. Steven Ramsey<br>University of Bristol</button>| <button class="speaker" onclick="openPopup(B4)"><b>The relative powers of shared-variable and message-passing communication: Possibility and impossibility of speed-independent mutual exclusion</b><br>Prof. Rob van Glabbeek<br>University of Edinburgh</button>|
| 15:00-15:30 | Break           | Break           |
| 15:30-16:30 |     <button class="speaker" onclick="openPopup(A5)"><b>Inductive types in the setoid model of type theory</b><br>Dr. Fredrik Norvall Forsberg<br>University of Strathclyde</button>| <button class="speaker" onclick="openPopup(B5)"><b>Ornaments as a dependently typed programming pattern</b><br>André Videla<br>Glasgow Lab for AI Verification</button>|
| 16:30-17:30 |     <button class="speaker" onclick="openPopup(A6)"><b>Avoiding the Billion Pound Mistake of Dependently Typed Programming by Being Positively Negative about Decisions</b><br>Dr. Jan de Muijnck-Hughes<br>University of Strathclyde</button>| <button class="speaker" onclick="openPopup(B6)"><b>Three Functional Programs for Appending Lists: In-Place, Stackless, Lazy</b><br>Anton Lorenzen<br>University of Edinburgh</button>|
