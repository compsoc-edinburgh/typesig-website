...
| <b>10:00 |     <button class="speaker" onclick="openPopup(A1)">Prof. Simon Gay<br>University of Glasgow</button>|<button class="speaker" onclick="openPopup(B1)">Dr. Renate Schmidt<br>University of Manchester</button>|
| <b>11:00 |     <button class="speaker" onclick="openPopup(A2)">Dr. Ohad Kammar<br>University of Edinburgh</button>| <button class="speaker" onclick="openPopup(B2)">Constantine Theocharis<br>University of St Andrews</button>|
| <b>12:00 | Lunch           | Lunch           |
| <b>13:00 |     <button class="speaker" onclick="openPopup(A3)">Dr. Vikraman Choudhury & Rin Liu<br>University of Strathclyde</button>| <button class="speaker" onclick="openPopup(B3)">Dr. Konstantin Korovin<br>University of Manchester</button>|
| <b>14:00 |     <button class="speaker" onclick="openPopup(A4)">Dr. Steven Ramsey<br>University of Bristol</button>| <button class="speaker" onclick="openPopup(B4)">Prof. Rob van Glabbeek<br>University of Edinburgh</button>|
| <b>15:00 | Break           | Break           |
| <b>15:30 |     <button class="speaker" onclick="openPopup(A5)">Dr. Fredrik Norvall Forsberg<br>University of Strathclyde</button>| <button class="speaker" onclick="openPopup(B5)">André Videla<br>Glasgow Lab for AI Verification</button>|
| <b>16:30 |     <button class="speaker" onclick="openPopup(A6)">Dr. Jan de Muijnck-Hughes<br>University of Strathclyde</button>| <button class="speaker" onclick="openPopup(B6)">Anton Lorenzen<br>University of Edinburgh</button>|
