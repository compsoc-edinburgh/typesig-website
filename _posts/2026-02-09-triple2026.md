...
const B5 = {
	"speaker": "Tune in on Monday for the final 3 talks!",
	"title": "",
	"abstract": ""
};
...
|     <button class="speaker" onclick="openPopup(A5)"><b>Inductive types in the setoid model of type theory</b><br>Dr. Fredrik Norvall Forsberg<br>University of Strathclyde</button>| <button class="speaker" onclick="openPopup(B5)">Tune back in on Monday for the last 3 talks!</button>|
