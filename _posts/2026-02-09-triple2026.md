...
|     Track A                                      | Track B                                   |
|---------------------------------------------|-------------------------------------------|
|     <button class="speaker" onclick="openPopup(A1)">Trains, Pictures and Types - Prof. Simon Gay, University of Glasgow</button>|<button class="speaker" onclick="openPopup(B1)">Title: Symbolic AI for Medical Knowledge Representation & Reasoning: Just The Right Amount -- SNOMED CT Content Extraction - Renate Schmidt, University of Manchester</button>|
|     <button class="speaker" onclick="openPopup(A2)">Algebra and Normalisation - Dr. Ohad Kammar, University of Edinburgh</button>| <button class="speaker" onclick="openPopup(B2)">Phase Your Compilation - Constantine Theocharis, University of St Andrews</button>|
|     <button class="speaker" onclick="openPopup(A3)">Programming with Cubes - Dr. Vikraman Choudhury & Rin Liu, University of Strathclyde</button>| <button class="speaker" onclick="openPopup(B3)">AI meets Formal: Verification and optimization of systems modelled using machine learning - Dr. Konstantin Korovin, University of Manchester</button>|
