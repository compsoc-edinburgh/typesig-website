...
| <b>15:00 | Break           | Break           |
| <b>15:30 |     <button class="speaker" onclick="openPopup(A5)">Dr. Vikraman Choudhury & Rin Liu<br>University of Strathclyde</button><br><a href="#">agda file</a>| <button class="speaker" onclick="openPopup(B5)">André Videla<br>Glasgow Lab for AI Verification</button><br><a href="#">slides</a>|
