...
| <b>15:00 | Break           | Break           |
| <b>15:30 |     <button class="speaker" onclick="openPopup(A5)">Dr. Fredrik Nordvall Forsberg<br>University of Strathclyde</button>| <button class="speaker" onclick="openPopup(B5)">André Videla<br>Glasgow Lab for AI Verification</button>|
