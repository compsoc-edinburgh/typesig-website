...
const A3 = {
  ...
  title: "Survey on Proof Complexity",
  abstract: "TBD"
};
...
| **10:00**  |     <button class="speaker" onclick="openPopup(A1)">Prof. Christian Ikenmeyer (Warwick)</button>        | <button class="speaker" onclick="openPopup(B1)">Dr. Nachi Valliappan (Edinburgh)</button>            |
| **11:00**  |     <button class="speaker" onclick="openPopup(A2)">Prof. Rahul Santhanam (Oxford)</button>   | <button class="speaker" onclick="openPopup(B2)">Orpheas van Rooij (Edinburgh)</button>           |
| **12:00**  |     Lunch                                 | Lunch                                    |
